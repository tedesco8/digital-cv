export default {
    ...
    skill: "Skills",
    jobDescription0: "I work as a tutor and software programming teacher for LECASABE creating online courses, workshops and bootcamps. In this role i try to bring my personal experience regarding software development for companies and the technical and practical details regarding Java, JavaScript, HTML and CSS languages including their frameworks and libraries.",
    ...
    jobDescription3: "I work as a web application developer in the Authentication Management team and in collaboration with others. My main role is to create maintainable and scalable web and hybrid applications applying software architecture and clean code techniques with Javascript, Typescript, React, Svelte, Ionic and Capacitor. I participate in the analysis, design and development of new features using Java and Spring Boot in a microservices context.",
